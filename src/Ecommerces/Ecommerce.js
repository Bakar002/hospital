...
const Ecommerce = () => {
    ...
    return (
        <div classNameName="container pt-6">
            <div classNameName="mb-4 text-center d-flex justify-content-center align-items-center">
                <h1 classNameName="medical-heading">E-commerce</h1>
                <img
                    alt="Logo"
                    classNameName="medical-logo ms-lg-2"
                    src={Logo}
            ...
            <div classNameName="services-grid">
                {services.map((service) => (
                    <div key={service.name} classNameName="service-card">
                        <NavLink
                            classNameName="text-center text-reset text-decoration-none"
                            to={`/${service.name.toLowerCase().replace(/\s+/g, "-")}`}
                        >
                            <div classNameName="mb-3 medical-img-container">
                                <img
                                    src={service.img}
                                    alt={`${service.name} Logo`}
                                    classNameName="service-img"
                                />
                            </div>
                            <h1 classNameName="service-name">{service.name}</h1>
                        </NavLink>
                    </div>
                ))}
            </div>
